...
Description: Marquee xml rss feed scroll
Author: Gopi.R
Version: 1.0
...
function rssshow()
{
	...
	if ( ! empty($item) ) 
	{
		...
		foreach( $item as $item )
		{
			...
			@$mxrf = @$mxrf . @$spliter . "<a href='".$links."'>" . @$title . "</a>";
			$count = $count + 1;
			if($count == 11)
			{
				break;
...
function mxrf_install() 
{
	...
	add_option('mxrf_rss1', "http://www.gopiplus.com/work/feed");
...
function mxrf_control() 
{
	...
	echo "<br>";
	echo "<a href='http://www.gopiplus.com/work/2011/08/10/marquee-xml-rss-feed-scroll-wordpress-scroll/' target='_blank'>Check official website for live demo</a>";
	echo "<br>";
}

function mxrf_widget_init()
{
  	register_sidebar_widget(__('Marquee xml rss feed'), 'mxrf_widget');   
	...
	{
		register_widget_control(array('Marquee xml rss feed', 'widgets'), 'mxrf_control');
	} 
}
...
function mxrf_option() 
{
    ...
    <ul>
    	<li><a href="http://www.gopiplus.com/work/2011/08/10/marquee-xml-rss-feed-scroll-wordpress-scroll/" target="_blank">Drag and drop the widget</a></li>
        <li><a href="http://www.gopiplus.com/work/2011/08/10/marquee-xml-rss-feed-scroll-wordpress-scroll/" target="_blank">Short code for posts and pages</a></li>
        <li><a href="http://www.gopiplus.com/work/2011/08/10/marquee-xml-rss-feed-scroll-wordpress-scroll/" target="_blank">Add directly in the theme</a></li>
    </ul>
    <h2>Check official website</h2>
    <ul>
    	<li><a href="http://www.gopiplus.com/work/2011/08/10/marquee-xml-rss-feed-scroll-wordpress-scroll/" target="_blank">Check official website for live demo</a></li>
    </ul>
    <?php
}
