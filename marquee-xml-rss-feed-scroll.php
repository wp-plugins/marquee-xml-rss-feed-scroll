...
function rssshow()
{
	...
	{
		@$url = "http://www.gopipulse.com/work/feed/";
	}
...
function mxrf_install() 
{
	...
	add_option('mxrf_rss1', "http://www.gopipulse.com/work/category/word-press-plug-in/feed/");
	add_option('mxrf_rss2', "http://www.gopipulse.com/extensions/feed");
...
function mxrf_option() 
{
    ...
    Note: Check official website for more info <a href="http://www.gopipulse.com/work/2011/08/10/marquee-xml-rss-feed-scroll-wordpress-scroll/" target="_blank">click here</a>
    <?php
}
